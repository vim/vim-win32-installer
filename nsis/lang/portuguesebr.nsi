...
LicenseLangString page_lic_file ${LANG_PORTUGUESEBR} "${SRC}\lang\LICENSE.pt_br.nsis.txt"
...
LangString str_group_cmdline        ${LANG_PORTUGUESEBR} \
    "Command line support"
LangString str_desc_cmdline         ${LANG_PORTUGUESEBR} \
    "Make Vim easier to use from the command line."
...
LangString str_section_launcher     ${LANG_PORTUGUESEBR} \
    "Vim launchers"
LangString str_desc_launcher        ${LANG_PORTUGUESEBR} \
    "Install small programs for Vim variants in the Windows directory \
     for command line use."

LangString str_section_addpath      ${LANG_PORTUGUESEBR} \
    "Add to PATH"
LangString str_desc_addpath         ${LANG_PORTUGUESEBR} \
