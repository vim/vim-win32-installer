...
set RACKET32_URL=https://download.racket-lang.org/releases/6.10.1/installers/racket-minimal-6.10.1-i386-win32.exe
set RACKET64_URL=https://download.racket-lang.org/releases/6.10.1/installers/racket-minimal-6.10.1-x86_64-win32.exe
